...
var ZoneService = /** @class */ (function () {
    ...
    ZoneService.getAllZones = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query('SELECT * FROM zones ORDER BY created_at DESC')];
                    case 1:
                        result = _a.sent();
    ...
    ZoneService.createZone = function (zone) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        values = [zone.name, zone.security_level, zone.color, JSON.stringify(zone.position)];
